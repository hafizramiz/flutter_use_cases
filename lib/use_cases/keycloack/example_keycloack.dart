...
class LoginScreen extends StatelessWidget {
  ...
  Future<void> login() async {
    ...
    /// ENGELLENECEK.  BUNU UNUTMA. KULLANICI LOGIN OLURKEN DE CONFIG BILGILERINI SERVER'A GONDERECEK
    /// CLIENT ID, REALM, FRONTEND URL GIBI, CLIENT SECRET GIBI DEGERLERI GONDERECEK
...
class HomeScreen extends StatelessWidget {
  ...
  /// Log out'da da boolen deger dondurur
